...
1. Sobre Computação Gráfica e Processamento de Imagens:
 ...
 # O profissional de computação gráfica deve ter um perfil criativo e tem habilidades em design, edição efeitos sonoros, visuais, criação e animação de objetos 2D e 3D, entre outras habilidades pertinentes.peguei da internet so mudei a primeira frase
